...
if(isset($_POST['Submit']))
{
  ...
  $CDOB=$_POST['DOB'];
  $uid=$_SESSION['id'];
  $query=mysqli_query($conn,"update Principal_data set full_name='$Cname' ,Mobile='$Cmobile' , Gender='$CGender',DOB='$CDOB' where id='$uid'");
            ...
            <div class="tab-pane active" id="home">
                <hr>
                  <form class="form" action="##" method="post" id="registrationForm">
                      ...
                      <div class="form-group">
                          <div class="col-xs-6">
                            <label for="last_name"><h4>Branch</h4></label>
                              <input type="text" class="form-control" name="Branch" placeholder="Select Branch" value="<?php echo $_SESSION['Branch']; ?>">
                          </div>
                      </div>
