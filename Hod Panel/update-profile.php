...
include_once 'header.php';
 ...
 ?>
<hr>
      <?php $ret=mysqli_query($conn,"select * from staff_data where id='".$_GET['uid']."'");
                  ...
                  <form class="form" action="##" method="post" id="registrationForm">
                      ...
                      <div class="form-group">
                          <div class="col-xs-6">
                              ...
                              <select type="Post" class="form-control" readonly  name="AYear"  id="Post">
                                <option><?php echo $row['AYear']; ?></option>
