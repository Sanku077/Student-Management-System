    ...
    <div class="row">
         <center>
                    ...
                    if (isset($_GET["error"])) {
                      ...
                      } else if ($_GET["error"]=="BranchTakan") {
                        echo "<p class='error_msg'>This Branch Hod is Already Created.</p>";
                      }
                    }
                    ?>
                    </center>
      <div class="col-sm-9">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="home">
                <hr>
                  <form class="form" action="includes/signup-hod.php" enctype="multipart/form-data" onSubmit="return valid();" method="post" id="registrationForm">
