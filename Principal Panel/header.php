...
<body>
  <div class="sidebar">
    <div class="logo-details">
      ...
      <ul class="nav-links">
        <li>
          <a href="Manage-hod.php" class="active">
            <i class="fa fa-users"></i>
            <span class="links_name">Manage Hod</span>
          </a>
        </li>
        <li>
          <a href="Add-hod.php">
            <i class="fa fa-user-plus" aria-hidden="true"></i>
            <span class="links_name">Add Hod</span>
          </a>
        </li>
        <li>
          <a href="Profile.php">
  ...
  <section class="home-section">
    <nav>
      ...
      <div class="profile-details">
        ...
        <img src="<?php echo "../Admin Panel/includes/".$_SESSION['profile_image']; ?>">
