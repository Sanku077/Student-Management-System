...
include_once 'header.php';
 ...
 ?>
<hr>
      <?php $ret=mysqli_query($conn,"select * from student_data where id='".$_GET['uid']."'");
                  ...
                  <form class="form" action="##" method="post" id="registrationForm">
                      ...
                      <div class="form-group">
                          <div class="col-xs-6">
                              ...
                              <input type="Post" class="form-control" name="AYear" id="Post" value="<?php echo $row['AYear']; ?>" readonly>
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          <div class="col-xs-6">
                              ...
                              <input type="Post" class="form-control" name="Branch" id="Post" value="<?php echo $row['Branch']; ?>" readonly>
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          <div class="col-xs-6">
                              ...
                              <input type="text" class="form-control" name="mother_tongue" id="email" value="<?php echo $row['mother_tongue']; ?>" readonly>
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          <div class="col-xs-6">
                              ...
                              <input type="text" class="form-control" name="religion" id="email" value="<?php echo $row['religion']; ?>" readonly>
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          <div class="col-xs-6">
                              ...
                              <input type="text" class="form-control" name="caste" id="email" value="<?php echo $row['caste']; ?>" readonly>
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          <div class="col-xs-6">
                              ...
                              <input type="text" class="form-control" name="sub_caste" id="email" value="<?php echo $row['sub_caste']; ?>" readonly>
                          </div>
                      </div>
                      ...
                      <div class="form-group"> 
                          <div class="col-xs-6">
                            <label for="last_name"><h4>District</h4></label>
                              <input type="text" class="form-control" name="district" placeholder="last name" value="<?php echo $row['district'] ?>" readonly>
                          </div>
                      </div>
                      ...
                      <div class="form-group"> 
                          <div class="col-xs-6">
                            <label for="last_name"><h4>State</h4></label>
                              <input type="text" class="form-control" name="state" placeholder="last name" value="<?php echo $row['state'] ?>" readonly>
                          </div>
                      </div>
                      ...
                      <div class="form-group"> 
                          <div class="col-xs-6">
                            <label for="last_name"><h4>Country</h4></label>
                              <input type="text" class="form-control" name="State" placeholder="last name" value="<?php echo $row['country'] ?>" readonly>
                          </div>
                      </div>
                      ...
                      <div class="form-group"> 
                          <div class="col-xs-6">
                            <label for="last_name"><h4>Pin</h4></label>
                              <input type="text" class="form-control" name="pin" placeholder="last name" value="<?php echo $row['pin'] ?>" readonly>
                          </div>
                      </div>
