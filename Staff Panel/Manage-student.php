...
<?php 
      if (isset($_POST["Submit"])) {
        ...
        if($name != "" || $email != "" || $AYear != "" || $Gender != "" ){
          $query = "SELECT * FROM student_data WHERE (full_name = '$name' AND AYear = '$Tyear' AND Branch = '$CurrentBranch') OR (AYear = '$AYear' AND AYear = '$Tyear' AND Branch = '$CurrentBranch') || (Gender = '$Gender' AND AYear = '$Tyear' AND Branch = '$CurrentBranch') OR (email = '$email' AND AYear = '$Tyear' AND Branch = '$CurrentBranch')";
        ...
        $Tyear = $_SESSION['AYear'];
        $ret=mysqli_query($conn,"SELECT * FROM student_data WHERE AYear = '$Tyear' AND Branch = '$CurrentBranch'");
                $cnt=1;
