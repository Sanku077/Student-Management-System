...
if(isset($_POST['Submit']))
{
  ...
  $CDOB=$_POST['DOB'];
  $uid=$_SESSION['id'];
  $query=mysqli_query($conn,"update staff_data set full_name='$Cname' ,Mobile='$Cmobile' , Gender='$CGender',DOB='$CDOB' where id='$uid'");
...
if(isset($_POST['Submit1']))
{
  ...
  $uid=$_SESSION['id'];
$query=mysqli_query($conn,"update staff_data set paddress='$Cpaddress' ,taddress='$Ctaddress' where id='$uid'");
 ...
 ?>
    ...
    <div class="row">
      ...
      <div class="text-center">
        <img src="<?php echo "../Hod Panel/includes/".$_SESSION['profile_image']; ?>" class="avatar  img-thumbnail" alt="avatar" width = "100" height="100">
            ...
            <div class="tab-pane active" id="home">
                <hr>
                  <form class="form" action="##" method="post" id="registrationForm">
                      ...
                      <div class="form-group">
                          <div class="col-xs-6">
                              <label for="Post"><h4>Teaching Year</h4></label>
