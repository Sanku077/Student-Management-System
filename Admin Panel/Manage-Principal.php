...
{
$adminid=$_GET['id'];
$msg=mysqli_query($conn,"delete from principal_data where id='$adminid'");
if($msg)
{
...
<thead>
  ...
  <tbody>
    <?php $ret=mysqli_query($conn,"select * from principal_data");
                $cnt=1;
    ...
    <tr>
      ...
      <td>
        ...
        <a href="Manage-Principal.php?id=<?php echo $row['id'];?>">
